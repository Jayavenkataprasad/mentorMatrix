          ...
          <div className="flex flex-col sm:flex-row gap-4 mb-6">
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 bg-purple-800/50 border border-purple-600/50 rounded-xl text-white placeholder-purple-300 focus:outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-400/20"
              />
            </div>
            <div className="flex gap-2">
              <select
                ...
                className="px-4 py-3 bg-purple-800/50 border border-purple-600/50 rounded-xl text-white focus:outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-400/20"
              >
        ...
        {/* Stats Cards */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
            ...
            <div className="bg-gradient-to-br from-green-800/50 to-emerald-800/50 backdrop-blur-xl border border-green-600/50 rounded-xl p-6 hover:bg-green-700/30 transition-all">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-green-200 text-sm mb-1">Answered</p>
        ...
        {/* Questions List */}
          <div className="space-y-6">
            {filteredQuestions.length === 0 ? (
              <div className="bg-gradient-to-br from-purple-800/50 to-indigo-800/50 backdrop-blur-xl border border-purple-600/50 rounded-xl p-12 text-center">
              ...
              filteredQuestions.map(question => (
                <div
                  key={question.id}
                  className="bg-gradient-to-br from-purple-800/50 to-indigo-800/50 backdrop-blur-xl border border-purple-600/50 rounded-xl p-6 hover:bg-purple-700/30 transition-all"
                >
                  {/* Question Header */}
                  <div className="flex items-start justify-between mb-4">
                    ...
                    {question.status === 'pending' && (
                      <button
                        ...
                        className="bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-4 py-2 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl flex items-center gap-2"
                      >
                        <Edit size={16} />
                        Answer
                      </button>
                ...
                {/* Question Content */}
                  <div className="bg-purple-700/30 backdrop-blur-sm border border-purple-600/50 p-4 rounded-lg mb-4">
                    <p className="text-purple-200 font-medium mb-2">Question:</p>
                  ...
                  {question.questionType === 'mcq' && question.options && (
                    <div className="mb-4">
                      <p className="text-purple-200 font-medium mb-2">Options:</p>
                    ...
                    <div className="border-t border-purple-600/50 pt-4">
                      ...
                      {question.questionType === 'mcq' ? (
                        <div className="space-y-2 mb-4">
                          {JSON.parse(question.options).map((option, index) => (
                            <label key={index} className="flex items-center gap-3 cursor-pointer hover:bg-purple-700/20 p-2 rounded-lg transition-colors">
                              <input
                                type="radio"
                        ...
                        <textarea
                          ...
                          className="w-full px-4 py-3 bg-purple-800/50 border-2 border-purple-600/50 rounded-xl text-white placeholder-purple-300 focus:outline-none focus:border-purple-400 focus:ring-2 focus:ring-purple-400/20"
                          rows="4"
                        />
                      )}
                      ...
                      <div className="flex gap-3 mt-4">
                        <button
                          ...
                          className="flex-1 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white px-6 py-3 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                        >
                          <Save size={18} />
                          Submit Answer
                        </button>
                        <button
                          ...
                          className="flex-1 bg-gradient-to-br from-slate-600 to-slate-700 hover:from-slate-700 hover:to-slate-800 text-white px-6 py-3 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl flex items-center justify-center gap-2"
                        >
                          <X size={18} />
                          Cancel
                        </button>
                ...
                {/* Existing Answer */}
                  {question.status === 'answered' && (
                    <div className="border-t border-purple-600/50 pt-4">
                      <h4 className="text-white font-semibold mb-3">Your Answer:</h4>
                      <div className="bg-gradient-to-br from-green-600/20 to-emerald-600/20 backdrop-blur-sm border-l-4 border-green-500 p-4 rounded">
                        {question.questionType === 'mcq' ? (
                          <div>
                            <p className="text-white mb-2">Selected: {question.studentAnswer}</p>
